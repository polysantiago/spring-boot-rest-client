...
public class RestClientCompletableFutureAsyncTest
    extends AbstractRestClientAsyncTest<CompletableFutureAsyncFooClient> {
  ...
  interface CompletableFutureAsyncFooClient extends AbstractRestClientAsyncTest.AsyncFooClient {
    ...
    CompletableFuture<Void> fooWithHeaders(
