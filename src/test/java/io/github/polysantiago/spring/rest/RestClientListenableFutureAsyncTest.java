...
public class RestClientListenableFutureAsyncTest
    extends AbstractRestClientAsyncTest<ListenableFutureAsyncFooClient> {

  @Mock private ListenableFutureCallback<Optional<String>> callback;

  @Test
  public void testRestClientWithEmptyOptionalAndCallback() {
    asyncServer
  ...
  interface ListenableFutureAsyncFooClient extends AbstractRestClientAsyncTest.AsyncFooClient {
    ...
    ListenableFuture<String> foo(
        @PathVariable("id") String id, @RequestParam("query") String query);
    ...
    ListenableFuture<Void> fooWithHeaders(
