...
import se.polysantiago.spring.rest.support.SyntheticParametrizedTypeReference;
import se.polysantiago.spring.rest.util.LocationFutureAdapter;
import se.polysantiago.spring.rest.util.OptionalTypeFutureAdapter;
import se.polysantiago.spring.rest.util.ResolvableTypeUtils;
import se.polysantiago.spring.rest.util.ResponseFutureAdapter;

import java.lang.reflect.Method;
import java.net.URI;
import java.util.Optional;

import static se.polysantiago.spring.rest.support.SyntheticParametrizedTypeReference.fromResolvableType;
